#!/usr/bin/python3
# 此脚本用于清除harbor镜像仓库中过老的镜像，默认保留20个tag，可自行修改，参数为`self.tag_number`
...
class Login(object):
    ...
    def loginStation(self):
        ...
        self.header = {
            ...
            "Cookie": "_xsrf=ODVXR0Q0NTdNUWcwWGVLWVdlaE9iSzdudkJnNGJ2aTE=|1657848859806446932|5150b14ea1eb6940bc831e72b44de19d2b3fed88; " + session_id, 
            "X-Xsrftoken": "85WGD457MQg0XeKYWehObK7nvBg4bvi1"
        }
        data = {
     ...
     #获取cookies中的session信息, curl -I -X GET http://harborrepo.domain.com/c/login
...
class ClearHarbor(object):
    def __init__(self, harbor_domain, username, password, schema="http"):
        ...
        self.username = username
        self.password = password
        self.tag_number = 20 # keep tag number
...
if __name__ == "__main__":
    ...
    print('-------------------------')
    harbor_domain = "harborrepo.domain.com" 
    username='user'
    password = "password"
    # 从返回结果来看，有登录成功
